...
import ProPic from './projectRobot.png'
...
const projectPage = () => {
  return (
    <div>
      ...
      <div className="relative"><img className=' h-[500px] w-full m-auto ' src={ProPic} alt="react" />
        <div className="absolute top-0 left-1/4  pt-20 text-white text-4xl italic ">
        <span className='text-[#AE8461]'>OUR</span> PROJECTS
        </div></div>
      <div className='leading-3 text-center font-bold text-[#AE8461] text-5xl pt-10'>MAJOR PROJECTS </div>
      <div className='text-center font-bold text-slate-300 text-5xl '>.......................</div>


      <div className='text-left font-semibold italic text-slate-300 text-3xl pl-5 pt-8'>Swab Testing <span className='text-[#AE8461]'> Robot:</span></div>
      <div className='grid grid-cols-2 gap-6'>
        <div className='text-slate-300  text-sm pl-5 pt-6 '>Amidst the ongoing global pandemic, this initiative aims to significantly contribute to risk mitigation and alleviate the burden on healthcare professionals. The project focuses on developing a fully automated robot specifically designed for conducting nasal and oropharyngeal swab tests. Featuring a 5-degree-of-freedom serial manipulator with a flexible end effector, the robotic system's workflow commences with nose detection utilizing a Kinect camera system, complemented by sophisticated image processing algorithms.<br /><br />
